...
section_data = {
    ...
    '台中-嘉義': {'geojson': "geojson/taichung_jiayi.geojson", 'center': [23.809488, 120.292326], 'station_csv': "csv/station_tcjia.csv"},
    '嘉義-高雄': {'geojson': "geojson/jiayi_kaohsung.geojson", 'center': [22.999866, 120.148435], 'station_csv': "csv/station_jiakao.csv"},
    '高雄-屏東': {'geojson': "geojson/kaohsung_pingtung.geojson", 'center': [22.402317, 120.536198], 'station_csv': "csv/station_kaoping.csv"},
    '屏東-台東': {'geojson': "geojson/pingtung_taitung.geojson", 'center': [22.781440, 120.834135], 'station_csv': "csv/station_pingtait.csv"},
    '台東-花蓮': {'geojson': "geojson/taitung_huaien.geojson", 'center': [23.429920, 121.335207], 'station_csv': "csv/station_taithua.csv"},
    '花蓮-宜蘭': {'geojson': "geojson/hualien_yilan.geojson", 'center': [24.228917, 121.532195], 'station_csv': "csv/station_huayi.csv"},
    '宜蘭-台北': {'geojson': "geojson/yilan_taipei.geojson", 'center': [24.899394, 121.675311], 'station_csv': "csv/station_yitaip.csv"},
}
...
if 'selected_route' in st.session_state:
    ...
    if route_info:
        ...
        try:
            ...
            st.error(f"找不到 '{station_csv_file}' 這個補給站 CSV 檔案，請確認檔案是否存在。")
            st.info("請確認 CSV 檔案位於 'csv/' 子目錄中，或提供正確的路徑。")
